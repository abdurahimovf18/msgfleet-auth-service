...
from src.auth_service.app.dependencies import db
from src.auth_service.core.flows import app as flows
from src.auth_service.app.dependencies import clients
...
async def register_user(param: p.RegisterDTO = Body(...), 
                 ...
                 users_client = Depends(clients.users_client)):  # -> r.RegisterDTO
